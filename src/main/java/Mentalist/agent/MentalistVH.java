...
public class MentalistVH extends MentalistCoreVH {
	...
	{
		super("Sympathizer", game, session, new MentalistRepeatedFavorBehavior(MentalistRepeatedFavorBehavior.LedgerBehavior.FAIR), new MentalistRepeatedFavorExpression(),
