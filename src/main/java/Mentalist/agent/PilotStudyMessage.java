...
public class PilotStudyMessage extends MentalistCoreMessage implements MessagePolicy {
	...
	private PilotStudyBehavior.LedgerBehavior lb;
	 ...
	 */
	public PilotStudyMessage(boolean isWithholding, boolean lying, PilotStudyBehavior.LedgerBehavior lb)
	{
