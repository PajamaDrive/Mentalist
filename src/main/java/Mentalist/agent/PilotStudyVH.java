...
public class PilotStudyVH extends MentalistCoreVH {
	...
	{
		super("PilotStudy", game, session, new PilotStudyBehavior(PilotStudyBehavior.LedgerBehavior.LIMITED), new PilotStudyExpression(),
				new PilotStudyMessage(false, false, PilotStudyBehavior.LedgerBehavior.FAIR));
