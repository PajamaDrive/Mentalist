...
import Mentalist.agent.PilotStudyBehavior.LedgerBehavior;


public class PilotStudyRepeatedFavorMessage extends MentalistCoreMessage implements MessagePolicy {
	 ...
	 */
	public PilotStudyRepeatedFavorMessage(boolean isWithholding, boolean lying, LedgerBehavior lb)
	{
